...
# # execution
# SRCS += ms_exec_cmd.c ms_exec_pipe.c
# SRCS += ms_exec_heredoc.c
...
# ## resources trackers, safety wrappers and exit logic
...
SRCS += ms_redi.c ms_exec_fs.c ms_exec_utils.c
